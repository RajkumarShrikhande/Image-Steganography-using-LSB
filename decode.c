 ...
 * Inputs: command line arguments, source image, secret file name
...
{
	//Validating the 2nd argument, checking the bmp file
    if (strcmp(strstr(argv[2], "."), ".bmp") == 0)
    {
    	//Assigning the 2nd position to the source image file
...
// Function definition for decoding the process
Status do_decoding(DecodeInfo *decInfo)
{
    ...
    {
        printf("INFO: Error in opening the required file\n");
        return d_failure;
    }
    return d_success;
}
